package com.example.subproject_kttkpm_14btt_haibaotunghiahuy_department.util;
...
public class JwtUtil {
    ...
    private static final String SECRET = "secret key for app ktpm 2021 nhom 7 HaiBaoTuNghiaHuy ";
